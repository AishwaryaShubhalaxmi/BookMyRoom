...
public class MyListener extends ApplicationTest implements ITestListener {
	...
	@Override
	 ...
	 public void onTestFailure(ITestResult result) {
	  ...
	  try {
	   FileUtils.copyFile(src, new File("C:\\Users\\M1046926\\Desktop\\images\\" + result.getMethod().getMethodName() + ".png"));
	   String file = test.addScreenCapture("C:\\Users\\M1046926\\Desktop\\images\\" + result.getMethod().getMethodName() + ".png");
